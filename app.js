...
var net = require('net');
var HOST = process.env.SOTA_HOST;
var PORT = process.env.SOTA_PORT;
var SOTA_MODE = process.env.SOTA_MODE;
...
//for SOTA ROBOT
app.post( '/api/sota', function(req, res) {
  if(SOTA_MODE == 'OFF') {
    console.log(req.body.message);
    return res.json({ "message": SOTA_MODE });
  } else {
    var body = req.body;
    var sota_message = "";
    if(body.message) sota_message = body.message;
    
    console.log(sota_message);
    client.connect(PORT, HOST, function() {
      console.log('CONNECTED TO: ' + HOST + ':' + PORT);
      // クライアントが接続次第、ソケットにメッセージを書き込みます。サーバーはこのデータを受信します。
      client.write(sota_message + '\n');
    });
